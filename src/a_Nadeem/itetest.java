...
//			RDD
	...
	public void start_loop() throws InterruptedException {
		logTableStart("Loop Test Results");
		for (i = 1; i <= 10; i++) { // Adjust the loop count as needed
			Place_Buy_order();
			Modify_Buy_order();
			Cancel_Buy_order();
		}
		logTableEnd("Loop Test Results");
	}
	...
	public void Place_Buy_order() throws InterruptedException {
		...
		try {
			...
			status = "Fail";
			System.err.println("Error during Buy order: " + e.getMessage());
		}

		long endTime = System.currentTimeMillis(); // End time
		long timeTaken = endTime - startTime;

		logTableRow("Place Buy Order", i, timeTaken, status);
	}
	...
	public void Modify_Buy_order() throws InterruptedException {
		...
		try {
			...
			status = "Fail";
			System.err.println("Error during Modify order: " + e.getMessage());
		}

		long endTime = System.currentTimeMillis(); // End time
		long timeTaken = endTime - startTime;

		logTableRow("Modify Buy Order", i, timeTaken, status);
	}
	...
	public void Cancel_Buy_order() throws InterruptedException {
		...
		try {
			...
			status = "Fail";
			System.err.println("Error during Cancel order: " + e.getMessage());
		}

		long endTime = System.currentTimeMillis(); // End time
		long timeTaken = endTime - startTime;

		logTableRow("Cancel Buy Order", i, timeTaken, status);
	}
