...
// Helper Methods for Logging Tables
	...
	public void Verify_user_launch_app() throws InterruptedException, IOException {
		 ...
		 * ) {
		 * 
		 * System.out.println("Initializing Appium..."); DesiredCapabilities
		 ...
		 * Commons.getGlobalPropertiesValue("Rise_app_package"));
		 * capabilities.setCapability("appActivity",
		 * Commons.getGlobalPropertiesValue("Rise_app_activity"));
		 * capabilities.setCapability("automationName", "UiAutomator2");
		 * capabilities.setCapability("autoGrantPermissions", true);
		 * capabilities.setCapability("noReset", true);
		 * 
		 * Driver = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"),
		 * capabilities); DriverFactory.addDriver(Driver);
		 * System.out.println("app launch succesfully");
		 * Driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20)); }
		 * 
		 * else if
		 * ("BrowserStack".equalsIgnoreCase(Commons.getGlobalPropertiesValue("Execution"
		 * ))) {
		 */
